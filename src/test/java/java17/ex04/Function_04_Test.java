...
public class Function_04_Test {
    ...
    // tag::predicateand[]
    Predicate<Person> lastnameIsFrance = person -> "France".equals(person.getLastname());

    Predicate<Person> firstnameIsArmor = person -> "Armor".equals(person.getFirstname());
    // end::predicateand[]
    ...
    public void test_predicate_and() throws Exception {
        ...
        List<Person> result = filter(personList, adult
                .and(lastnameIsFrance)
                .and(firstnameIsArmor));
